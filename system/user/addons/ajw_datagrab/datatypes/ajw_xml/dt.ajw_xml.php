	...
	function settings_form( $values = array() ) {
		...
		$form = array(
			...
			array(
				...
				'<div class="subtext">The path within the XML to the element you want to import (eg, /rss/channel/item). <br/>If importing an RSS/ATOM feed, leave blank and it will try and guess. <br/><strong>Note: this is not the path to the file.</strong></div>',
				form_input(
					array(
						'name' => 'path',
						'id' => 'path',
