<div class="TaggerField col-group" id="TaggerField_<?=$field_id?>" data-fieldname="<?=$field_name?>" data-fieldid="<?=$field_id?>">

<div class="col <?=($config['show_most_used'] == 'yes') ? 'w-8' : 'w-16';?>">
...
<div class="col w-8 last" style="padding-left:5px">
<div class="TagBox">
